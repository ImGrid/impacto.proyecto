      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        ...
        {!open ? null : !departamentosData ||
          ...
          <RecolectorForm
            ...
            tiposGenerador={tiposGenData.data}
...
function RecolectorForm({
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      tipos_generador_ids:
        recolector?.recolector_tipo_generador.map((rt) =>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        {!isEditing && (
          <fieldset className="space-y-4">
            <legend className="text-sm font-semibold">Cuenta de usuario</legend>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col justify-end">
                  <div className="flex items-center gap-2 h-9">
                    ...
                    <FormLabel className="!mt-0">Trabaja individual</FormLabel>
                  </div>
                  <FormMessage />
                </FormItem>
              )}
                ...
                >
                  ...
                  <SelectContent>
                    {asociaciones.map((asoc) => (
                      <SelectItem key={asoc.id} value={String(asoc.id)}>
                        {asoc.nombre}
                      </SelectItem>
                    ))}
                  </SelectContent>
