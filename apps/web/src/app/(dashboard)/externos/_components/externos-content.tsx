...
export function ExternosContent() {
  ...
  const { data, isLoading } = useExternos({
    page,
    limit: pageSize,
    search,
    activo,
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-4">
        <div className="relative max-w-sm flex-1">
          ...
          <Input
            placeholder="Buscar por nombre o asociación..."
            value={search}
      ...
      <ExternoFormDialog open={createOpen} onOpenChange={setCreateOpen} />
    </div>
  );
}
