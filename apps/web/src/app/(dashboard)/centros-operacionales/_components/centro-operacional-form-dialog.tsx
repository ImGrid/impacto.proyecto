...
interface CentroOperacionalFormDialogProps {
  open: boolean;
 ...
 */
export function CentroOperacionalFormDialog({
  open,
  onOpenChange,
  centro,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle>
            {isEditing
              ? "Editar centro operacional"
              : "Crear centro operacional"}
          </DialogTitle>
          <DialogDescription>
            {isEditing
              ? "Modifique los datos del centro operacional."
              : "Complete los datos para registrar un nuevo centro operacional."}
          </DialogDescription>
        </DialogHeader>
...
function CentroOperacionalForm({
  ...
  const isEditing = !!centro;
  const createMutation = useCreateCentroOperacional();
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      cedula_identidad: centro?.cedula_identidad ?? "",
      celular: centro?.celular ?? "",
      ...
      longitud:
        centro && centro.longitud != null ? Number(centro.longitud) : null,
      horario_operacion: centro?.horario_operacion ?? "",
    },
  });
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Nombre del punto operacional</FormLabel>
              <FormControl>
                <Input
                  placeholder="Nombre del centro operacional"
                  disabled={isPending}
                  {...field}
                />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="Dirección del punto operacional"
                  disabled={isPending}
                  {...field}
                />
              </FormControl>
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-xs">
            Haga click en el mapa para marcar la ubicación del centro
            operacional. Puede arrastrar el marcador para ajustar la
            posición.
          </p>
          <MapPicker
